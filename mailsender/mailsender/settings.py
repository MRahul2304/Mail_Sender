...
SECRET_KEY = 'django-insecure-fb)@_g+%o_gd19h#ngnm0leevpak-k!4rexe(l%s9(ewbw9*y0'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'mailsender/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = '#sendersemail-id'
